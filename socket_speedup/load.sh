...
clang -O2 -g -target bpf -c bpf_sockops.c -o bpf_sockops.o -I /usr/include/aarch64-linux-gnu
...
clang -O2 -g -Wall -target bpf -c bpf_redir.c -o bpf_redir.o -I /usr/include/aarch64-linux-gnu
